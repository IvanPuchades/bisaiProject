...
import com.fujica.bisai.service.MailService;
import com.fujica.bisai.service.UserService;
import com.fujica.bisai.service.dto.UserDTO;
import com.fujica.bisai.web.rest.vm.KeyAndPasswordVM;
                ...
                .orElseGet(() -> {
                    ...
                    if(managedUserVM.getLangKey() == null){
                        user = userService.createUser(managedUserVM.getLogin(), managedUserVM.getPassword(),
                            ...
                            "en", managedUserVM.getNickName());
                    }
                    else{
                        user = userService.createUser(managedUserVM.getLogin(), managedUserVM.getPassword(),
                            managedUserVM.getFirstName(), managedUserVM.getLastName(), managedUserVM.getEmail().toLowerCase(),
                            managedUserVM.getLangKey(), managedUserVM.getNickName());
                    }
